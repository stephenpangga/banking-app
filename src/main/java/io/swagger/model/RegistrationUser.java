...
public class RegistrationUser extends BaseUser  {
  ...
  public RegistrationUser email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public RegistrationUser password(String password) {
  ...
  **/
  ...
  public RegistrationUser accessLevel(AccessLevelEnum accessLevel) {
